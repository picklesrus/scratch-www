...
const Steps = require('../../components/registration/join-steps.jsx');
...
const IntlJoin = injectIntl(Join);

const mapStateToProps = state => ({
    session: state.session.session
});

const ConnectedJoin = connect(mapStateToProps)(IntlJoin);

render(<ConnectedJoin />, document.getElementById('app'));
